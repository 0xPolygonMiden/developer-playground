...
const examples = ["P2ID.masm", "P2IDR.masm", "SWAP.masm"];
...
export default function DropDown({
  ...
  const [selected, setSelected] = useState(
    localStorage.getItem(LOCAL_STORAGE.SELECTED_NOTE_SCRIPT) ?? examples[0]
  );

  useEffect(() => {
    if (!localStorage.getItem(LOCAL_STORAGE.NOTE_SCRIPT_CODE)) {
